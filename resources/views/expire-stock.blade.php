           ...
           <main class="h-full pb-16 overflow-y-auto">
               <div class="container grid px-6 mx-auto">
                 ...
                 <a href="#" class="capitalize flex justify-center mx-auto text-center items-center mt-3 mb-1">
                    <img src="{{ asset('assets/img/expirestock.svg') }}" class="img-responsive shadow rounded-lg" width="200px" height="200px" alt="">
                    <br>
               </a>
               <p class="text-xs text-center capitalize text-red-400 mt-2 mb-1">no Expire Stocks were found</p>
